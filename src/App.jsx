      ...
      <div className="app">
        ...
        <header className="hdr">
          <div className="hleft">
            ...
            <div>
              <div className="title">Dividend Finder</div>
        ...
        <div className="footer">Dividend Finder | {holdings.length} positions | {fmt(ann)} projected annual income | Your data stays in your browser</div>
      </div>
